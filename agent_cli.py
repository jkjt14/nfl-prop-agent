...
DEFAULT_CFG = {
    ...
    "sigma_defaults": {
        "QB": {
            "player_pass_yds": 60, "player_pass_tds": 0.75, "player_interceptions": 0.5,
            "player_pass_attempts": 6, "player_pass_completions": 5
        },
        "RB": {
            "player_rush_yds": 20, "player_rush_tds": 0.5, "player_receptions": 1.6,
            "player_reception_yds": 18, "player_longest_rush": 7
        },
        "WR": {
            "player_receptions": 2.0, "player_reception_yds": 30, "player_reception_tds": 0.5,
            "player_longest_reception": 8
        },
        "TE": {
            "player_receptions": 1.6, "player_reception_yds": 22, "player_reception_tds": 0.45,
...
def main():
    ...
    ap.add_argument("--config", default="", help="Optional JSON/YAML config file path")
    args = ap.parse_args()
